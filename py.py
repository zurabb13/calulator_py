...
btn_equals = tk.Button(root, text="=", command=evaluate_calculation, width=17, font=("Arial",14))
btn_equals.grid(row=6, column=1, columnspan=2)
btn_clear = tk.Button(root, text="C", command=clear_field, width=17, font=("Arial",14))
